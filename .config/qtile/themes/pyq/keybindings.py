...
def keymappings():
    return [
        ...
        Key([mod], "s" , lf.run_rofi , desc="Launch rofi"),
        Key([mod], "Tab", lazy.next_layout(), desc="Toggle between layouts"),
        Key([mod], "w", lazy.window.kill(), desc="Kill focused window"),
        Key([mod, "control"], "r", lazy.reload_config(), desc="Reload the config"),
        Key([mod, "control"], "t", lf.run_theme_manager, desc="Change of theme"),
        Key([mod, "control"], "q", lf.run_powermenu ,desc="Run powermenu"),
